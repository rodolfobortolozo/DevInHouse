...
<head>
<title> Registrar Entrada para Janta</title>
...
<h1>Registrar Entrada para a Janta:</h1>
<form id="qual-id" name="qual-id" method="post" onsubmit="validaForm(); return false;" action="registrandoJanta.php">
